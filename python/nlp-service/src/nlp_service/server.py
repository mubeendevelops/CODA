...
Phase 0: serves gRPC + HTTP health only. PII redaction, thought construction,
thought-graph assembly, MeSH/ICD-10 linking, GoT-lite reasoning, and
distillation land in Phases 3, 6 and 7 (docs/architecture.md §1.2
nlp-service; this worker must never touch audio or own workflow state).
"""
